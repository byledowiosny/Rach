...
{  
  ...
  fprintf (ofp, "%-39s  %5s %4d  %5s %4d\n",
	  "ACTIF", "Année", (annee_comptable - 1), "Année", annee_comptable);
  for (p=0; p<63; p++)
    fprintf (ofp, "-");
  fprintf (ofp, "\n");
  ...
  fprintf (ofp, "  %-37s  %10.2f  %10.2f\n",
	   "Actif immobilisé", 0.00, immobilise);
  for (p=0; p<63; p++)
    fprintf (ofp, "-");
  fprintf (ofp, "\n");
  ...
  fprintf (ofp, "   +%-35s  %10.2f  %10.2f\n",
	   "Disponibilités", 0.00, disponibilites);
  ...
  fprintf (ofp, "%-39s  %5s %4d  %5s %4d\n",
	  "PASSIF", "Année", (annee_comptable - 1), "Année", annee_comptable);
  for (p=0; p<63; p++)
    fprintf (ofp, "-");
  fprintf (ofp, "\n");
  ...
  fprintf (ofp, "   +%-35s  %10.2f  %10.2f\n",
	   "Résultat de l'exercice", 0.00, result);
  for (p=0; p<63; p++)
  fprintf (ofp, "-");
  fprintf (ofp, "\n");
  ...
  fprintf (ofp, "  %-37s  %10.2f  %10.2f\n",
	   "Dettes à long terme", 0.00, long_terme);
  for (p=0; p<63; p++)
    fprintf (ofp, "-");
  fprintf (ofp, "\n");
  ...
  fprintf (ofp, "  %-37s  %10.2f  %10.2f\n",
	   "Dettes à court terme", 0.00, court_terme);
  for (p=0; p<63; p++)
    fprintf (ofp, "-");
  fprintf (ofp, "\n");
